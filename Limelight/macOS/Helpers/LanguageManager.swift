...
public class LanguageManager: NSObject, ObservableObject {
  ...
  private let en: [String: String] = [
    ...
    "Performance Overlay (Ctrl+Opt+S)": "Performance Overlay (Ctrl+Opt+S)",
    ...
    "Long-press Menu to Toggle Mouse Mode": "Long-press Menu to Toggle Mouse Mode",
    "Long-press Menu Mouse Hint": "Hold Menu for 1 second to switch between controller and mouse mode.",
    "Drivers": "Drivers",
    "Advanced": "Advanced",
  ...
  private let zhHans: [String: String] = [
    ...
    "Performance Overlay (Ctrl+Opt+S)": "显示性能统计（Ctrl+Opt+S）",
    ...
    "Long-press Menu to Toggle Mouse Mode": "长按 Menu 切换鼠标模式",
    "Long-press Menu Mouse Hint": "长按 Menu 约 1 秒，在手柄模式和鼠标模式之间切换。",
    "Mouse": "鼠标",
